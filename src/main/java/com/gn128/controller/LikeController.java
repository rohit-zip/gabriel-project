...
public class LikeController {
    ...
    public ResponseEntity<ListResponse> userLikes(@AuthenticationPrincipal UserPrincipal userPrincipal) {
        return ResponseEntity.ok(likeService.getUserLikes(userPrincipal));
    }
}
