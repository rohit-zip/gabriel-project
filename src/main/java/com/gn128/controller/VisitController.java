...
public class VisitController {
    ...
    public ResponseEntity<ListResponse> getVisits(@AuthenticationPrincipal UserPrincipal userPrincipal) {
        return ResponseEntity.ok(AsyncUtils.getAsyncResult(visitService.getVisits(userPrincipal)));
    }
}
